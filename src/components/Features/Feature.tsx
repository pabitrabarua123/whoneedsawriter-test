...
export const Feature = ({
  ...
  const buttonGradient = useColorModeValue(
    "linear-gradient(to right, #667eea 0%, #764ba2 51%, #667eea 100%)", // Light mode gradient
    "linear-gradient(to right, #B2FEFA 0%, #0ED2F7 51%, #B2FEFA 100%)"  // Dark mode gradient
  );
  
  // Define different text colors for light and dark modes (same as Hero)
